...
func TestNewContainer(t *testing.T) {
	client := NewClient()
	container := NewContainer(client, "abc123", "test-container", "Test Container", "running")
...
func TestNewDindContainer(t *testing.T) {
	client := NewClient()
	container := NewDindContainer(client, "host123", "host-container", "dind456", "dind-container", "running")
