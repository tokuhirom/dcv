...
func (m *Model) CmdQuit(_ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
	m.quitConfirmation = true
	return m, nil
}

func (m *Model) CmdCommandMode(_ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
	// Start command mode
	m.commandViewModel.Start()
	return m, nil
}

func (m *Model) CmdToggleNavbar(_ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
...
func (m *Model) CmdRefresh(_ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
...
func (m *Model) CmdCancel(msg tea.KeyPressMsg) (tea.Model, tea.Cmd) {
...
func (m *Model) CmdHelp(_ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
